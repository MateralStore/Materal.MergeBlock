...
/// ModuleName控制器
/// </summary>
[Route("ModuleNameAPI/[controller]/[action]")]
public abstract class ModuleNameController : MergeBlockController
{
}
/// <summary>
/// ModuleName控制器
...
[Route("ModuleNameAPI/[controller]/[action]")]
public abstract class ModuleNameController<TService> : MergeBlockController<TService>
...
/// <typeparam name="TService"></typeparam>
[Route("ModuleNameAPI/[controller]/[action]")]
public abstract class ModuleNameController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService> : MergeBlockController<TAddRequestModel, TEditRequestModel, TQueryRequestModel, TAddModel, TEditModel, TQueryModel, TDTO, TListDTO, TService>
