/* Generated by: Materal.MergeBlock.GeneratorCode.DefaultPlug.DTOGeneratorCodePlug+<GeneratorListDTOModelAsync>d__3.MoveNext */namespace MMB.Demo.Abstractions.DTO.User
{
    /// <summary>
    /// 用户列表数据传输模型
    /// </summary>
