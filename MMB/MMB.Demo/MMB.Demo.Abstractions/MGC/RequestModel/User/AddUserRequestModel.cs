/* Generated by: Materal.MergeBlock.GeneratorCode.DefaultPlug.RequesetModelGeneratorCodePlug+<GeneratorAddRequestModelAsync>d__3.MoveNext */namespace MMB.Demo.Abstractions.RequestModel.User
{
    /// <summary>
    /// 用户添加请求模型
    /// </summary>
