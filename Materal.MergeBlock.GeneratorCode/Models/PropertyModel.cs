...
namespace Materal.MergeBlock.GeneratorCode.Models
{
    ...
    public class PropertyModel
    {
        ...
        /// 验证特性组
        /// </summary>
        public List<AttributeModel> VerificationAttributes => [.. Attributes.Where(m => _validationAttributeWhiteList.Contains(m.Name))];
        /// <summary>
        /// 查询特性组
        /// </summary>
        public List<AttributeModel> QueryAttributes => [.. Attributes.Where(m => _queryAttributeWhiteList.Contains(m.Name))];
        /// <summary>
        /// 是否有查询特性
        /// </summary>
