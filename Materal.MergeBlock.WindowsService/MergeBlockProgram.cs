...
namespace Materal.MergeBlock.WindowsService
{
    /// <summary>
    /// MergeBlock程序
    /// </summary>
    public static class MergeBlockProgram
    {
        ...
        /// <param name="servieName"></param>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task RunAsync(string[] args, string servieName, CancellationToken? cancellationToken = null)
            => await RunAsync(args, options => options.ServiceName = servieName, cancellationToken);
        /// <summary>
        /// 运行
        /// </summary>
        /// <param name="args"></param>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public static async Task RunAsync(string[] args, Action<WindowsServiceLifetimeOptions> options, CancellationToken? cancellationToken = null)
        {
