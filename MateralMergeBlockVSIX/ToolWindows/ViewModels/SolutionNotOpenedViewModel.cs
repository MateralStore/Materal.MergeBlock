...
namespace MateralMergeBlockVSIX.ToolWindows.ViewModels
{
    ...
    {
        public string? ProjectName { get; set { field = value; NotifyPropertyChanged(); } } = "MMB";

        public string ModuleName { get; set { field = value; NotifyPropertyChanged(); } } = "NewModule";

        public string ProjectPath { get; set { field = value; NotifyPropertyChanged(); } } = @"C:\Project\MMB";
        ...
        private void ApplyTemplate(string filePath, string templateName)
        {
            ...
            template = template.Replace("${Version}", "1.2.30");
